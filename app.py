...
def load_whisper_model():
    # မြန်မာဘာသာစကားအတွက် အကောင်းဆုံးဖြစ်အောင် ပြင်ထားသည်
...
# ပုံထဲကအတိုင်း အဝါရောင်ကို Default ထားပေးထားပါတယ်
text_color = st.sidebar.color_picker("စာလုံးအရောင် (အဝါရောင်)", "#FFFF00")
...
if uploaded_file:
    ...
    if 'segments' not in st.session_state:
        with st.spinner("AI မြန်မာစာသားထုတ်ယူနေသည်..."):
    ...
    st.subheader("📝 မြန်မာစာသားများ ပြင်ဆင်ရန်")
    # AI ထုတ်ပေးတဲ့စာသား မှားနေရင် ဒီနေရာမှာ မြန်မာလို ပြင်ရိုက်ပါ
    ...
    if st.button("🚀 ဗီဒီယိုထဲသို့ မြန်မာစာတန်းထိုးမည်"):
        with st.spinner("Rendering..."):
            ...
            while cap.isOpened():
                ...
                # မြန်မာစာပေါ်အောင် pyidaungsu.ttf ကိုပဲ သုံးပါ
            ...
            st.success("ပြီးပါပြီ! အောက်တွင် ဒေါင်းလုဒ်လုပ်နိုင်ပါသည်။")
